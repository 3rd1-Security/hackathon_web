...
<body>
    ...
    <script type="text/javascript">
        ...
        $.get("scraping-APIs-master/casestudyscrpaer.php", function(Data){
            ...
            for(var i=0;i<len;++i){
                ...
                { 
                   ...
                   var a1 = "<div class='card' style=width:25%><div class='card-body'><p><h5>";
                    var b1=array.data[i].head;
                    var b2="</h5></p><a href =";
                    var b3=array.data[i].link;
                    var b4="><img src=";
                  var a = array.data[i].img;
                  var a2= " class='card-img-top' alt='...'></a><br><br>";
                    var c2="<p>";
                  ...
                  var g; 
                      ...
                      g.id = i;
                      $(".card-deck").after(g);
                      var abc = a1+b1+b2+b3+b4+a+a2+c2+c3+c4;
